...
test('selezionare il profilo "Dinamico" non cambia il punteggio assegnato a una risposta corretta', async ({ browser }) => {
  test.setTimeout(60_000);
  ...
  await admin.fill('#setupScoringCorrect', '7');
  ...
  expect(points).toBe(7); // esattamente config.scoring.correct, nessun bonus/penalità dinamici applicati
